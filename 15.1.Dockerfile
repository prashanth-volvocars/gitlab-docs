...
# and rename it to 15.1.Dockerfile, where 15.1 the major.minor GitLab version.
#
...
ENV VER=15.1
ENV CI_COMMIT_REF_NAME=15.1

# Replace the versions to match the stable branches of the upstream projects
ENV BRANCH_EE=15-1-stable-ee
ENV BRANCH_OMNIBUS=15-1-stable
ENV BRANCH_RUNNER=15-1-stable
ENV BRANCH_CHARTS=6-1-stable
